...
Config = {
    ...
    disableAutoAIM        = false,         -- Disables auto-aim for controller players if set to false.
    ...
    HealthRecharge           = { enable = true, multiplier = 0.4 }, -- Auto-recharge for health, with a multiplier for speed.

    StaminaRecharge          = { enable = true, multiplier = 0.4 },  -- Auto-recharge for stamina, with a multiplier for speed.

    RespawnTime              = 100,                                   -- Time in seconds before a player can respawn.
    ...
    TimeZone                 = " CST",              -- Set your server's timezone.

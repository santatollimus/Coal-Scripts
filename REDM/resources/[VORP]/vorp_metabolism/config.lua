Config = {
  ...
  EveryTimeStatusDown = 100000,          -- Time interval (in milliseconds) for status drop (3.6 seconds).
  ...
  ItemsToUse = {
      ...
      InnerCoreHealth = 10,
      OuterCoreHealth = 5,
      PropName = "S_INV_APPLE01X",
      Animation = "eat",
      Effect = "",
      EffectDuration = "",
      GiveBackItemLabel = "Apple Seed",
      GiveBackItem = "Apple_Seed",

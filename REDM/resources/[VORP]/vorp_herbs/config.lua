...
Config.Plants = {
    {                                               -- location that can be base game spawned and still pick it
        ...
        minReward = 10,                              -- Minimum reward per plant (optional, defaults to 1!)
        maxReward = 10,                              -- Maximum reward per plant (optional, defaults to 1!)
        cooldown = 10,                               -- Cooldown for this plant (in minutes)

...
--if Config.fertilizerSetup and type(Config.fertilizerSetup) == "table" then
...
--    end
--else
--    DBG.Warning("Config.fertilizerSetup is nil or not a table – skipping fertilizer check")
--end
...
-- Fertilizer disabled – always plant without it
local bestFertilizer = nil
DBG.Info("Fertilizer system disabled for planting.")

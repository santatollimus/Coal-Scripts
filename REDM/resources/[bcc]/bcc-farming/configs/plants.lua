Plants = {
    {
        ...
        plantingToolUsage = 0,             -- Durability value removed from the tool when planting a seed
    ...
    -----------------------------------------------------
    {
        ...
        seedAmount = 1,                    -- Amount of soil required to plant the seed
        plantProp = 'P_TREE_APPLE_01',     -- Prop for the plant to be spawned
        soilRequired = false,              -- If true, the seed will require soil to be planted
        soilAmount = 1,                    -- Amount of soil required to plant the seed
        soilName = 'soil',                 -- Item name for the soil required to plant the seed
        timeToGrow = 1800,                 -- Time in seconds for the plant to grow
        ...
        -- Growth stage props (client uses plantData.stageProps[1..3])
        stageProps = {
            [1] = 's_ginsengpicked01x',        -- small / sprout
            [2] = 'p_tree_birch_01_sapling',   -- young tree
            [3] = 'P_TREE_APPLE_01'            -- full apple tree
        },
